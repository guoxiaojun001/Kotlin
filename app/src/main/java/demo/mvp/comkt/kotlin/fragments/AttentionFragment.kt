...
import kotlinx.android.synthetic.main.custom_tab_ac_layout.*
...
class AttentionFragment : Fragment() {
    ...
    fun newInstance(from : String):AttentionFragment{
        var fragment = AttentionFragment();
        var bounder = Bundle();
    ...
    override fun onResume() {
        super.onResume()
        Log.d("TTTT","AttentionFragment onResume = " );
    }
